...
export interface User { id: number; name: string; email: string; phone?: string; is_admin: boolean; role?: string | null; is_active: boolean; created_at: string; }
